...
var MenuItem = /*#__PURE__*/function () {
  function MenuItem(el) {
    ...
    this.createTimeline();
    this.initEvents();
    this.addMouseMoveListener(); // Add mouse move listener
  }
  return _createClass(MenuItem, [{
    ...
    value: function initEvents() {
      this.DOM.textsGroupEl.style.filter = "url(#".concat(this.filterId, ")");
    }
  }, {
    ...
    value: function onMouseMove(event) {
      var timelineProgress = event.clientX / window.innerWidth;
      var stdDeviation = 1.5 + event.clientY / window.innerHeight * (15 - 1.5);
      this.settings.timeline = timelineProgress;
      this.settings.stdDeviation = stdDeviation;
    ...
    value: function onTimelineChange() {
      this.tl.pause();
    ...
    value: function onColorMatrixChange() {
      var _this$settings$colorM = this.settings.colorMatrix,
        r = _this$settings$colorM.r,
        g = _this$settings$colorM.g,
        b = _this$settings$colorM.b,
        a = _this$settings$colorM.a;
      var values = [].concat(_toConsumableArray(r), _toConsumableArray(g), _toConsumableArray(b), _toConsumableArray(a)).join(" ");
      this.DOM.feColorMatrix.setAttribute("values", values);
    }
  }, {
    key: "onLoopChange",
    value: function onLoopChange() {
    ...
    value: function loadJSON() {
      ...
      input.onchange = function (event) {
        ...
        reader.onload = function (e) {
          ...
          Object.assign(_this5.settings, loadedSettings);
          _this5.onDurationChange();
          _this5.onStdDeviationChange();
          _this5.onColorMatrixChange();
          _this5.onLoopChange();
          _this5.onText1Change();
          _this5.onText2Change();
        };
        reader.readAsText(file);
      };
      input.click();
    ...
    value: function createTimeline() {
      ...
      this.tl = _gsap.gsap.timeline({
        ...
        onUpdate: function onUpdate() {
          _this6.DOM.feBlur.setAttribute("stdDeviation", _this6.primitiveValues.stdDeviation);
          _this6.settings.timeline = _this6.tl.progress();
        }
        ...
        stdDeviation: function stdDeviation() {
          return _this6.settings.stdDeviation * 10;
        }
...
},{"gsap":"../node_modules/gsap/index.js","dat.gui":"../node_modules/dat.gui/build/dat.gui.module.js"}],"js/demo2/menu.js":[function(require,module,exports) {
"use strict";
...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
var Menu = exports.default = /*#__PURE__*/_createClass(function Menu(el) {
  var _this = this;
...
},{"./menuItem":"js/demo2/menuItem.js"}],"js/utils.js":[function(require,module,exports) {
"use strict";
...
},{"./menu":"js/demo2/menu.js","../utils":"js/utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
